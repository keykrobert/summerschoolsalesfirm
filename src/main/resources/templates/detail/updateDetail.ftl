...
<div>
    <form name="issuedBook" action="" method="POST">
        ...
        <div class="mb-3" style="width: 50%">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1"
                   aria-describedby="emailHelp" <@spring.formInput "form.sku" "" "text" />
        </div>
        <div class="mb-3" style="width: 50%">
            <label for="exampleInputEmail1" class="form-label">Price</label>
            <input  type="text" class="form-control" id="exampleInputEmail1"
                    aria-describedby="emailHelp" <@spring.formInput "form.price" "" "text" />
        </div>
        <div class="mb-3" style="width: 50%">
            <label for="exampleInputEmail1" class="form-label">Comment</label>
            <input type="text" class="form-control" id="exampleInputEmail1"
                   aria-describedby="emailHelp" <@spring.formInput "form.comment" "" "text" />
        </div>
        <div class="mb-3" style="width: 50%">
            <label for="exampleInputEmail1" class="form-label">Comment</label>
            <select class="form-select" id="exampleInputEmail1"
                   aria-describedby="emailHelp" <@spring.formSingleSelect "form.currency", currency "" />
        </div>
